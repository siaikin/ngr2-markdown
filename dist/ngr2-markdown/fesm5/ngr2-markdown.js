...
import { Injectable, Directive, ElementRef, Component, ViewChild, ViewEncapsulation, Pipe, Input, HostListener, TemplateRef, ViewContainerRef, ContentChildren, IterableDiffers, EventEmitter, Output, ContentChild, NgModule, Renderer2, defineInjectable } from '@angular/core';
...
var TreeNodeOutletDirective = /** @class */ (function () {
    ...
    /** @nocollapse */
    TreeNodeOutletDirective.ctorParameters = function () { return [
...
var TreeNodeDefDirective = /** @class */ (function () {
    ...
    /** @nocollapse */
    TreeNodeDefDirective.ctorParameters = function () { return [
        { type: TemplateRef }
    ]; };
