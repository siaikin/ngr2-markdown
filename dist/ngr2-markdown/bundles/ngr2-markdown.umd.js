    ...
    ***************************************************************************** */
    ...
    var ShortcutKeyEvent = /** @class */ (function () {
        function ShortcutKeyEvent(el, sKOpts) {
            if (sKOpts === void 0) {
                sKOpts = ShortcutKeyEvent.SHORTCUT_KEY_OPTIONS;
            }
            this._el = el;
            this.sKOpts = sKOpts;
         ...
         */
            function (eventType, options) {
                /** @type {?} */
                var observable = rxjs.fromEvent(this._el, eventType, options, ( /**
                 * @param {?} args
                 * @return {?}
         ...
         */
             ...
             * @return {?}
             */function (event) {
                    return event.shiftKey === (option.shortcutKey.shift || false) &&
